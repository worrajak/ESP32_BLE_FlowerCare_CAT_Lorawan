...
#include "BLEDevice.h"
#define FLORA_ADDR "c4:7c:8d:66:00:00"
...
static const u4_t DEVADDR = 0x000011B4;

static const u1_t PROGMEM DEVEUI[8]={ 0x00, 0x00, 0x00, 0xCA, 0x65, 0xDF, 0x1D, 0x8C };
...
void onEvent (ev_t ev) {
    ...
    switch(ev) {
        ...
        case EV_TXCOMPLETE:
            ...
            display.drawString(0, 6, "Deep sleep 60s");
...
void readData(){
    ...
    sprintf(buf1,"P%2.1f %2.0fm.",pressure,altitude);
